...
namespace ToyRobotTests
{
    public class CommandFactoryTest
    {
        ...
        {
            string mockedInput = StringCommand.PlaceRobot + " " + Data.validRow().ToString() + "," + Data.validCol().ToString() + "," + Data.validDirection();
            Coordinate coordinate = new Coordinate(Data.validCol(), Data.validRow());
            Mock.Arrange(() => mockedValidation.validateLocation(Data.validRow(), Data.validCol(), Data.validDirection())).Returns(true);
            ...
            Mock.Assert(() => mockedValidation.validateLocation(Data.validRow(), Data.validCol(), Data.validDirection()), Occurs.Once());
        ...
        {
            string mockedInput = StringCommand.PlaceRobot + " " + Data.invalidRow().ToString() + "," + Data.validCol().ToString();
        ...
        {
            string mockedInput = StringCommand.PlaceRobot + " " + "ONE" + "," + Data.validCol().ToString() + "," + Data.validDirection();
        ...
        {
            string mockedInput = StringCommand.PlaceRobot + " " + Data.invalidRow().ToString() + "," + Data.validCol().ToString() + "," + Data.validDirection();
            Mock.Arrange(() => mockedValidation.validateLocation(Data.invalidRow(), Data.validCol(), Data.validDirection())).Returns(false);

            Exception e = Assert.Throws<Exception>(() => commandFactory.getCommand(mockedInput, mockedBoard, mockedGameUI));

            Mock.Assert(() => mockedValidation.validateLocation(Data.invalidRow(), Data.validCol(), Data.validDirection()), Occurs.Once());
        ...
        {
            string mockedInput = StringCommand.PlaceRobot + " " + Data.validRow().ToString() + "," + Data.validCol().ToString() + "," + Data.invalidDirection();
            Mock.Arrange(() => mockedValidation.validateLocation(Data.validRow(), Data.validCol(), Data.invalidDirection())).Returns(false);

            Exception e = Assert.Throws<Exception>(() => commandFactory.getCommand(mockedInput, mockedBoard, mockedGameUI));

            Mock.Assert(() => mockedValidation.validateLocation(Data.validRow(), Data.validCol(), Data.invalidDirection()), Occurs.Once());
            Assert.That(e.Message, Is.EqualTo("Invalid coordinate or direction"));
        }
        ...
        public void fabricate_a_place_wall_command_with_valid_and_not_occupied_coordinate()
        {
            ...
            Mock.Arrange(() => mockedValidation.validateCoordinate(Data.validRow(), Data.validCol())).Returns(true);
            Coordinate coordinate = new Coordinate(Data.validCol(), Data.validRow());
            Mock.Arrange(() => mockedValidation.isOccupiedCoordinate(coordinate, mockedBoard)).Returns(false);

            ICommand command = commandFactory.getCommand(mockedinput, mockedBoard, mockedGameUI);

            Mock.Assert(() => mockedValidation.validateCoordinate(Data.validRow(), Data.validCol()), Occurs.Once());
            Mock.Assert(() => mockedValidation.isOccupiedCoordinate(coordinate, mockedBoard), Occurs.Once());
        ...
        {
            string mockedInput = StringCommand.PlaceWall + " " + Data.validCol().ToString();
        ...
        {
            string mockedInput = StringCommand.PlaceWall + " " + "ONE" + "," + Data.validCol().ToString();
        ...
        {
            string mockedinput = StringCommand.PlaceWall + " " + Data.invalidRow().ToString() + "," + Data.validCol().ToString();
            Mock.Arrange(() => mockedValidation.validateCoordinate(Data.invalidRow(), Data.validCol())).Returns(false);

            Exception e = Assert.Throws<Exception>(() => commandFactory.getCommand(mockedinput, mockedBoard, mockedGameUI));

            Mock.Assert(() => mockedValidation.validateCoordinate(Data.invalidRow(), Data.validCol()), Occurs.Once());
